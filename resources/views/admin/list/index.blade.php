        ...
        <div class="col-md-12">
            <div class="box">
                <div class="box-header with-border">
                    <form style="display: inline" action="{{route(!str_contains(url()->current(), 'college')?'admin.vuz.page':'admin.college.page')}}" method="get">
                        <input style="width: 84%; margin-right: 1rem; display: inline-block" name="n" class="form-control" placeholder="Название {{!str_contains(url()->current(), 'college')?'ВУЗа':'колледжа'}}" type="text" @if(isset($n)) value="{{ $n }}" @endif>

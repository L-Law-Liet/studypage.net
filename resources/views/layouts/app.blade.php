...
@stack('css')
    ...
    <noscript><div><img src="https://mc.yandex.ru/watch/72571912" style="position:absolute; left:-9999px;" alt="" /></div></noscript>
    <!-- /Yandex.Metrika counter -->
    ...
    <div id="header2">
        ...
        <div class="slideList mb-0 slideList-menu">
            <ul class="pb-0 mb-0">
                ...
                <li>
                    <img style="margin-right: 5px;" src="{{asset('/img/arrow-dots-grey.svg')}}" alt="->">
                    <a class="" href="{{url('qazaqstan/navigator/list/universities')}}">Список ВУЗов</a>
                </li>
                <li>
                    <img style="margin-right: 5px;" src="{{asset('/img/arrow-dots-grey.svg')}}" alt="->">
                ...
                <li><a class="" href="{{url('qazaqstan/calculator-ent')}}">Калькулятор ЕНТ</a></li>
            </ul>
        </div>
    </div>
        ...
        <div class="container {{ isset($is_main) ? 'is_index' : '' }}">
            <div class="collapse navbar-collapse {{ isset($is_main) ? 'is_index' : '' }}" id="navbarSupportedContent">
                ...
                <ul class="navbar-nav {{ isset($is_main) ? 'is_index' : '' }}">
                    ...
                    <li class="nav-item">
                        <a class="nav-link  @if(($active ?? '') == 'ent-calc')active @endif" href="{{url('qazaqstan/calculator-ent')}}">КАЛЬКУЛЯТОР ЕНТ</a>
                    </li>
{{--                    <li class="nav-item">--}}

...
return [
    ...
    */
    ...
    'custom' => [
        'email' => [
            'unique' => 'Такая электронная почта уже зарегистрирована',
        ...
        'phone' => [
            'numeric' => 'Неверный формат контактного телефона',
            'required' => 'Введите пожалуйста контактный телефон',
            'min' => 'Неверный формат контактного телефона',
        ],
        'contact_phone' => [
            'numeric' => 'Неверный формат контактного телефона',
            'required' => 'Введите пожалуйста контактный телефон',
        ...
        'password_confirmation' => [
            ...
            'same' => 'Пароль и его подтверждение не совпадают',
